 ...
 * Text Domain: test-plugin-file-type-compressed-errors
 *
 * @package test-plugin-file-type-compressed-errors
 */

/**
 * Plugin folder contains a ZIP file which is not allowed.
 */
