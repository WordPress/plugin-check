...
class Plugin_Readme_Check_Tests extends WP_UnitTestCase {
	...
	public function test_run_with_no_errors_license_mpl() {
		$readme_check  = new Plugin_Readme_Check();
		$check_context = new Check_Context( UNIT_TESTS_PLUGIN_DIR . 'test-plugin-plugin-readme-no-errors-license-mpl/load.php' );
		$check_result  = new Check_Result( $check_context );
	...
	public function test_run_with_errors_license_mpl() {
		$readme_check  = new Plugin_Readme_Check();
		$check_context = new Check_Context( UNIT_TESTS_PLUGIN_DIR . 'test-plugin-plugin-readme-errors-license-mpl/load.php' );
		$check_result  = new Check_Result( $check_context );
