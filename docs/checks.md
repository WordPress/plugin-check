...
| runtime_fatal_prevention | plugin_repo | Detects high-risk runtime patterns (unguarded dynamic requires, optional integrations, and fragile callbacks) that commonly cause fatal errors. | [Learn more](https://developer.wordpress.org/plugins/plugin-basics/best-practices/) |
